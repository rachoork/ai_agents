...
# Tool Message is the one containing Tool result
# System Message is the wrapper around the system to LLM
# Human Message is the input to the LLM like User Query
...
tools_for_llm = [
    {
        ...
        "function": {
            ...
            "description": "Look for the price of the product in the Catalogue",
            "parameters": {
                "type": "object",
                "properties": {
                    "product": {
    ...
    },
    {
        ...
        "function": {
            "name": "apply_discount",
            "description": "Apply discount tier to the price and return the final price",
            "parameters": {
                "type": "object",
                "properties": {
                    "price": {
...
def ollamaChatModel(messages):
    return ollama.chat(odel=Model, tools = tools_for_llm, temperature=0, messages= messages)
